...
import 'package:flutter_woo_getx_learn/pages/goods/home/widgets/home_placehold.dart';
      ...
      builder: (_) {
        return Scaffold(
          ...
          body: SmartRefresher(
            ...
            child: controller.flashShellProductList.isEmpty ||
                    controller.newProductList.isEmpty
                ? const HomePlaceholdWidget() //占位图
                // : const HomePlaceholdWidget(),
                : _buildView(),
          ),
        );
      },
