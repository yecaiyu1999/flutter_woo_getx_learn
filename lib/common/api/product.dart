...
class ProductApi {
  ...
  /// 商品列表
  static Future<List<ProductModel>> products(ProductReq? req) async {
    var res = await WPHttpService.to.get(
      '/products',
      params: req?.toJson(),
    );
  ...
  /// 评论列表
  static Future<List<ReviewModel>> reviews(ReviewReq? req) async {
    var res = await WPHttpService.to.get(
      '/products/reviews',
      params: req?.toJson(),
    );
  ...
  /// tags 列表
  static Future<List<TagsModel>> tags(TagReq? req) async {
    var res = await WPHttpService.to.get(
      '/products/tags',
      params: req?.toJson(),
    );
